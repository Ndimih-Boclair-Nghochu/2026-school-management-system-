...
const adminTabs = [
  { key: 'ai-assistant', label: 'AI Assistant', icon: FaUserGraduate },
  { key: 'dashboard', label: 'Dashboard', icon: FaTachometerAlt },
  { key: 'schools', label: 'School', icon: FaSchool },
  { key: 'users', label: 'Users', icon: FaUsers },
  { key: 'admin-enrolment', label: 'Admin Enrolment', icon: FaUserShield },
  { key: 'students', label: 'Students', icon: FaUserGraduate },
  { key: 'id-cards', label: 'ID Cards', icon: FaIdCard },
